...
//        [windowController setWindowFrameAutosaveName:@"dripr"];
//
...
{
  [self.popover showRelativeToRect:self.item.button.bounds ofView:self.item.button preferredEdge:NSMinYEdge];
}
...
- (void)setUpApplicationMenu
{
    ...
    [rootMenu addItemWithTitle:@"Quit dripr" action:@selector(terminate:) keyEquivalent:@"q"];
